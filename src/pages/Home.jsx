                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            <h3 className='mb-0 text-black fw-bold'><div style={{ color: '   #1a1a1a' }}>
                            Welcome To,              
    </div></h3>
                            <h1 className='mb-5 text-black fw-bold text-center text-sm-start'>
                            <div style={{ color: ' #1A1A1A' }}>
                            The London Fusion <h4  className='mb-0 text-black fw-bold'><div style={{ color: '   #1A1A1A', margin: 15 }}>
            ...
            <div className='container my-5'>
                <div className='row'>
                    ...
                    <div className='col-lg-6 d-flex flex-column align-items-center justify-content-center'>
                        ...
                        <p>A Global Gastronomic Experience:

Discover a culinary adventure at our restaurant. We blend the world's finest flavors into extraordinary dishes. From the vibrant spices of Asia to the rich tastes of Europe, our menu is a passport to global cuisine. Immerse yourself in a symphony of tastes as we reimagine classic recipes with a modern twist. Every bite is a journey, and our passion is your satisfaction.</p>
                        <p className='mb-5'>Based in the heart of London, our fusion restaurant offers a captivating culinary journey. Experience the vibrant tapestry of global flavors as we seamlessly blend traditional recipes with modern techniques</p>
                        <Link to="/about">
