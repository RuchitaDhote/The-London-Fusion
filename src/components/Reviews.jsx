                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        <CardBody>
                            <div className="p-4">
                                <CardText>
                                Amazing food, incredible service! The fusion of flavors was mind-blowing. Can't wait to come back.
                                </CardText>
                            </div>
                        </CardBody>
                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        <CardBody>
                            <div className="p-4">
                                <CardText>
                                Best fusion restaurant in London! The atmosphere was perfect for a date night and the food was even better.
                                </CardText>
                            </div>
                        </CardBody>
                        <CardFooter className="d-flex align-items-center">
                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        <CardBody>
                            <div className="p-4">
                                <CardText>
                                Such a delightful dining experience. The staff were friendly and knowledgeable. Will definitely recommend to friends.
                                </CardText>
                            </div>
                        </CardBody>
                        <CardFooter className="d-flex align-items-center">
                ...
                <div className="col-lg-6">
                    <Card className="h-100 shadow">
                        <CardBody>
                            <div className="p-4">
                                <CardText>
                                Had the most amazing meal here last night! The flavors were explosive. A must-visit for food lovers.
                                </CardText>
                            </div>
                        </CardBody>
                        <CardFooter className="d-flex align-items-center">
